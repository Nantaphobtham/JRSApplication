            ...
            searchOptionsByRoleFunction = new Dictionary<string, Dictionary<string, List<string>>>
            {
                ...
                },
                {
                    "Sitesupervisor", new Dictionary<string, List<string>>
                    {
                        ...
                        {
                            "ผลการอนุมัติ",
                            new List<string> { "รหัสโครงการ", "เลขที่สัญญา", "เฟสที่" }
                        },
                        {
                            "ผลการอนุมัติใบสั่งซื้อ",
                            new List<string> { "รหัสโครงการ", "เลขที่สัญญา", "เลขที่ใบสั่งซื้อ" }
                        },
                        {
                            "ออกใบสั่งซื้อ",
                            new List<string> {"เลขที่ใบสั่งซื้อ" , "สถานะใบสั่งซื้อ"}
                        }
                ...
                },
                {
                    ...
                    "Accountant", new Dictionary<string, List<string>>
                    {
                        {
                            "จัดการการเงิน",
                            new List<string> { "รหัสใบแจ้งหนี้", "สถานะ" }
                        }
                    }
                },
                {
